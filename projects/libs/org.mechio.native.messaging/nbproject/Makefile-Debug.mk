...
${OBJECTDIR}/_ext/609706966/AvroQpidOutputStream.o: ../../../src/messaging/AvroQpidOutputStream.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../../../include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/609706966/AvroQpidOutputStream.o ../../../src/messaging/AvroQpidOutputStream.cpp

${OBJECTDIR}/_ext/609706966/MessageDrain.o: ../../../src/messaging/MessageDrain.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/609706966
	${RM} $@.d
	$(COMPILE.cc) -g -I../../../include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/609706966/MessageDrain.o ../../../src/messaging/MessageDrain.cpp

${OBJECTDIR}/_ext/609706966/MessagingProvider.o: ../../../src/messaging/MessagingProvider.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/609706966
	${RM} $@.d
	$(COMPILE.cc) -g -I../../../include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/609706966/MessagingProvider.o ../../../src/messaging/MessagingProvider.cpp
