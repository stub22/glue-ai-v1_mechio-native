...
${OBJECTDIR}/_ext/981954651/MotionDetectService.o: ../../../src/vision/proc/motiondetect/MotionDetectService.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/981954651/MotionDetectService.o ../../../src/vision/proc/motiondetect/MotionDetectService.cpp

${OBJECTDIR}/_ext/981954651/MotionDetector.o: ../../../src/vision/proc/motiondetect/MotionDetector.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/981954651
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/981954651/MotionDetector.o ../../../src/vision/proc/motiondetect/MotionDetector.cpp
