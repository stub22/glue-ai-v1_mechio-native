...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/multii2c: ../../libs/org.mechio.native.i2cusb/dist/Release/GNU-Linux-x86/liborg.mechio.native.i2cusb.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/multii2c: ../../libs/org.mechio.native.messaging/dist/Release/GNU-Linux-x86/liborg.mechio.native.messaging.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/multii2c: ../../libs/org.mechio.native.common/dist/Release/GNU-Linux-x86/liborg.mechio.native.common.so
...
${OBJECTDIR}/MultiI2c.o: MultiI2c.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include -MMD -MP -MF $@.d -o ${OBJECTDIR}/MultiI2c.o MultiI2c.cpp
