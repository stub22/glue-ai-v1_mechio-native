...
#ifndef PORTABLEIMAGE_H_3870869419__H_
#define PORTABLEIMAGE_H_3870869419__H_
...
namespace avro {
template<> struct codec_traits<ImageRecord> {
    static void encode(Encoder& e, const ImageRecord& v) {
    ...
    static void decode(Decoder& d, ImageRecord& v) {
