...
LDLIBSOPTIONS=-Wl,-rpath,../../libs/org.mechio.native.speech/dist/Release/GNU-Linux-x86 -L../../libs/org.mechio.native.speech/dist/Release/GNU-Linux-x86 -lorg.mechio.native.speech -Wl,-rpath,../../libs/org.mechio.native.messaging/dist/Release/GNU-Linux-x86 -L../../libs/org.mechio.native.messaging/dist/Release/GNU-Linux-x86 -lorg.mechio.native.messaging -Wl,-rpath,../../libs/org.mechio.native.common/dist/Release/GNU-Linux-x86 -L../../libs/org.mechio.native.common/dist/Release/GNU-Linux-x86 -lorg.mechio.native.common -lavrocpp -lboost_thread -lboost_system

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/speechpipelistener

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/speechpipelistener: ../../libs/org.mechio.native.speech/dist/Release/GNU-Linux-x86/liborg.mechio.native.speech.so
...
# Subprojects
.build-subprojects:
	cd ../../libs/org.mechio.native.speech && ${MAKE}  -f Makefile CONF=Release
...
# Subprojects
.clean-subprojects:
	cd ../../libs/org.mechio.native.speech && ${MAKE}  -f Makefile CONF=Release clean
