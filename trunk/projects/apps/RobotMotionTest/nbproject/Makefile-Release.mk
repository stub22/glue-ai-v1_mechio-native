...
LDLIBSOPTIONS=-Wl,-rpath,../../libs/org.mechio.native.motion/dist/Release/GNU-Linux-x86 -L../../libs/org.mechio.native.motion/dist/Release/GNU-Linux-x86 -lorg.mechio.native.motion -Wl,-rpath,../../libs/org.mechio.native.messaging/dist/Release/GNU-Linux-x86 -L../../libs/org.mechio.native.messaging/dist/Release/GNU-Linux-x86 -lorg.mechio.native.messaging -Wl,-rpath,../../libs/org.mechio.native.common/dist/Release/GNU-Linux-x86 -L../../libs/org.mechio.native.common/dist/Release/GNU-Linux-x86 -lorg.mechio.native.common -lboost_thread -lavrocpp -lboost_system

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/robotmotiontest

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/robotmotiontest: ../../libs/org.mechio.native.motion/dist/Release/GNU-Linux-x86/liborg.mechio.native.motion.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/robotmotiontest: ../../libs/org.mechio.native.messaging/dist/Release/GNU-Linux-x86/liborg.mechio.native.messaging.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/robotmotiontest: ../../libs/org.mechio.native.common/dist/Release/GNU-Linux-x86/liborg.mechio.native.common.so
...
# Subprojects
.build-subprojects:
	cd ../../libs/org.mechio.native.motion && ${MAKE}  -f Makefile CONF=Release
...
# Subprojects
.clean-subprojects:
	cd ../../libs/org.mechio.native.motion && ${MAKE}  -f Makefile CONF=Release clean
