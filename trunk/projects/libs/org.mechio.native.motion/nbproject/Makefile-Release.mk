...
${OBJECTDIR}/_ext/888527952/MotionFrameReceiver.o: ../../../src/motion/MotionFrameReceiver.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/888527952/MotionFrameReceiver.o ../../../src/motion/MotionFrameReceiver.cpp

${OBJECTDIR}/_ext/888527952/MotionFrameSender.o: ../../../src/motion/MotionFrameSender.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/888527952
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/888527952/MotionFrameSender.o ../../../src/motion/MotionFrameSender.cpp

${OBJECTDIR}/_ext/888527952/RobotProxy.o: ../../../src/motion/RobotProxy.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/888527952
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/888527952/RobotProxy.o ../../../src/motion/RobotProxy.cpp
